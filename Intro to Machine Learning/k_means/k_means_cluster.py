...
def Draw(pred, features, poi, mark_poi=False, name="image.png", \
    ...
    ### if you like, place red stars over points
    ### that are POIs (just for funsies)
    if mark_poi:
        for ii, pp in enumerate(pred):
            if poi[ii]:
...
### load in the dict of dicts containing all the
### data on each person in the dataset
